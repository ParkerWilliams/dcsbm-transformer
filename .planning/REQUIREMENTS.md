...
- [ ] **GRPH-01**: System generates DCSBM directed graphs with configurable number of vertices (n), blocks (K), in-group probability (p_in), out-group probability (p_out), and degree correction parameters per Karrer & Newman 2011
...
- [ ] **GRPH-03**: System validates graph connectivity (strongly connected), minimum expected degree >= 3, and edge density matching expected p_in/p_out ratios
